...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function loadChatPage (){
        ...
        document.querySelector("#main").addEventListener("animationend", () =>  {      
            // history API:
            history.pushState({"title": "Chat", "name": name}, "Chat of " + name, name);
    ...
    document.querySelector("#createChannel").onclick = () => {
        if (socketReady) {
            ...
            socket.emit("publish channel", {"channelId": newChannelId, "channelName": newChannelName});
        }
    }
